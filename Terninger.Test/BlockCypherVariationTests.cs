...
namespace MurrayGrant.Terninger.Test
{
    ...
    public class BlockCypherVariationTests
    {
        ...
        {
            var crngAes128 = new BlockCypherCprngGenerator(_ZeroKey16Bytes, CryptoPrimitive.Aes128Managed(), SHA256.Create(), new CypherCounter(16));
            var crngAes256 = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256Managed(), SHA256.Create(), new CypherCounter(16));
        ...
        {
            var crngSha256 = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256Managed(), SHA256.Create(), new CypherCounter(16));
            var crngSha512 = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256Managed(), SHA512.Create(), new CypherCounter(16));
        ...
        {
            var crng1 = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256(), SHA256.Create(), new CypherCounter(16, 1));
            var crng2 = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256(), SHA256.Create(), new CypherCounter(16, 2));
        ...
        {
            var crng = new BlockCypherCprngGenerator(_ZeroKey16Bytes, CryptoPrimitive.Aes128Managed(), MD5.Create(), new CypherCounter(16));
        ...
        {
            var crng = new BlockCypherCprngGenerator(_ZeroKey16Bytes, CryptoPrimitive.Aes128Managed(), SHA1.Create(), new CypherCounter(16));
            var buffer = new byte[crng.BlockSizeBytes * 2];
            crng.FillWithRandomBytes(buffer);
        ...
        {
            var crng = new BlockCypherCprngGenerator(_ZeroKey16Bytes, CryptoPrimitive.RijndaelManaged(128, 128), SHA256.Create(), new CypherCounter(16));
            var buffer = new byte[crng.BlockSizeBytes * 2];
            crng.FillWithRandomBytes(buffer);
        ...
        {
            var crng = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.RijndaelManaged(256, 128), SHA256.Create(), new CypherCounter(16));
            var buffer = new byte[crng.BlockSizeBytes * 2];
            crng.FillWithRandomBytes(buffer);
        ...
        {
            var crng = new BlockCypherCprngGenerator(_ZeroKey16Bytes, CryptoPrimitive.RijndaelManaged(128, 256), SHA256.Create(), new CypherCounter(32));
            var buffer = new byte[crng.BlockSizeBytes * 2];
            crng.FillWithRandomBytes(buffer);
        ...
        {
            var crng = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.RijndaelManaged(256, 256), SHA256.Create(), new CypherCounter(32));
            var buffer = new byte[crng.BlockSizeBytes * 2];
            crng.FillWithRandomBytes(buffer);
        ...
        {
            var crng1 = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256(), SHA256.Create(), new CypherCounter(16), CheapEntropy.Get16);
            var crng2 = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256(), SHA256.Create(), new CypherCounter(16), CheapEntropy.Get16);
            var buffer1 = new byte[crng1.BlockSizeBytes * 2];
            var buffer2 = new byte[crng2.BlockSizeBytes * 2];
            crng1.FillWithRandomBytes(buffer1);
            crng2.FillWithRandomBytes(buffer2);
        ...
        {
            var crng1 = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256(), SHA256.Create(), new CypherCounter(16), CheapEntropy.Get32);
            var crng2 = new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256(), SHA256.Create(), new CypherCounter(16), CheapEntropy.Get32);
            var buffer1 = new byte[crng1.BlockSizeBytes * 2];
            var buffer2 = new byte[crng2.BlockSizeBytes * 2];
            crng1.FillWithRandomBytes(buffer1);
            crng2.FillWithRandomBytes(buffer2);
        ...
        public void MismatchedKeyMaterialAndCypherKeySizeThrows()
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => 
                new BlockCypherCprngGenerator(_ZeroKey16Bytes, CryptoPrimitive.Aes256Managed(), SHA256.Create(), new CypherCounter(16))
            );
        }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(() =>
                new BlockCypherCprngGenerator(new byte[14], CreateCryptoPrimitive(new TripleDESCryptoServiceProvider()), SHA256.Create(), new CypherCounter(16))
            );
        }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(() =>
                new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256(), MD5.Create(), new CypherCounter(16))
            );
        }
        [TestMethod]
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(() =>
                new BlockCypherCprngGenerator(_ZeroKey32Bytes, CryptoPrimitive.Aes256(), SHA256.Create(), new CypherCounter(32))
            );
        }
